  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested customer" do
        ...
        expect(customer.name).to eq('Customer Name 2')
        expect(customer.email).to eq('customer2@gmail.com')
        expect(customer.phone_number).to eq('(62) 34567-8349')
      end
